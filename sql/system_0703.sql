...
-- 2-1. session 권한 부여 --> 접속 권한, table 생성, view 생성
GRANT CREATE SESSION, CREATE TABLE, CREATE VIEW TO usertest02;

-- 2-2. 현장에서 DBA가  개발자 권한 부여 (connect와 resource가 있어야 한다.)
GRANT CONNECT, RESOURCE TO usertest03;
-- 2-3. 권한 부여와 회수
GRANT DBA TO usertest04;    --나중에 sysnonym 권한 주기 위해
--DBA 권한 회수
...
--현장 work) system 에 있는 systemTBL에 READ 권한 usertest04에게 주세요
...
INSERT INTO privateTBL VALUES('나는 진짜 황보슬');
INSERT INTO privateTBL VALUES('내 이상형은 도겨미><');
